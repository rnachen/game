...
export 
./gameserver -gip 127.0.0.1 -seq replay -d 1 -m 10000 -b 50 -t 2000 -h 500 0</dev/null 1>/dev/null 2>/dev/null &
popd >/dev/null
...
for i in 1 2 3 4 5 6 7 8
do
  #nohup ./game.py 127.0.0.1 6000 127.0.0.$i 600$i $i$i$i$i 0</dev/null 1>/dev/null 2>/dev/null &
  ./game.py 127.0.0.1 6000 127.0.0.$i 600$i $i$i$i$i 0 &
done
popd >/dev/null
